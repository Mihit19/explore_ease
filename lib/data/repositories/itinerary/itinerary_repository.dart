...
class ItineraryRepository extends GetxController {
  static ItineraryRepository get instance => Get.find();
...
// Get all order related to current User
  Future<List<ItineraryModel>> fetchUserItinerary() async {
    try {
      ...
      return result.docs.map((documentSnapshot) =>
          ItineraryModel.fromSnapshot(documentSnapshot)).toList();
    } catch (e) {
  ...
  Future<void> saveItinerary(ItineraryModel order, String userId) async {
    try {
