...
class EEUserProfileTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text('Mihit Kumar', style: Theme.of(context).textTheme.headlineSmall!.apply(color: EEColors.white)),
      subtitle: Text('mrmihitkumar@gmail.com', style: Theme.of(context).textTheme.bodyMedium!.apply(color: EEColors.white)),
